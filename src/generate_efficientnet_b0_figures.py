...
def generate_training_curves():
    ...
    history_path = "results/metrics/efficientnet_b0_training_history.csv"
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy (%)")
    plt.title("efficientnet_b0 Training and Validation Accuracy")
    plt.legend()
    plt.grid(True, alpha=0.3)

    plt.tight_layout()

    accuracy_path = "results/figures/efficientnet_b0_accuracy_curve.png"
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title("efficientnet_b0 Training and Validation Loss")
    plt.legend()
    plt.grid(True, alpha=0.3)

    plt.tight_layout()

    loss_path = "results/figures/efficientnet_b0_loss_curve.png"
    ...
    plt.title("efficientnet_b0 Learning Rate Schedule")
    plt.grid(True, alpha=0.3)

    plt.tight_layout()

    lr_path = "results/figures/efficientnet_b0_learning_rate.png"
    ...
    plt.title("efficientnet_b0 Training Time per Epoch")
    plt.grid(True, alpha=0.3)

    plt.tight_layout()

    time_path = "results/figures/efficientnet_b0_epoch_time.png"
...
def generate_roc_curves():
    ...
    output_path = os.path.join(
        FIGURES_DIR,
        "efficientnet_b0_roc_curves.png"
    )
    ...
    auc_output_path = os.path.join(
        METRICS_DIR,
        "efficientnet_b0_auc_scores.csv"
    )
...
def main():
    ...
    print(
        "GENERATING efficientnet_b0 FIGURES"
    )
