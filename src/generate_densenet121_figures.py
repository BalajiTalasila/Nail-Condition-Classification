...
def generate_training_curves():
    ...
    history_path = "results/metrics/densenet121_training_history.csv"
    ...
    accuracy_path = "results/figures/densenet121_accuracy_curve.png"
    ...
    loss_path = "results/figures/densenet121_loss_curve.png"
    ...
    plt.title("DENSENET121 Learning Rate Schedule")
    plt.grid(True, alpha=0.3)

    plt.tight_layout()

    lr_path = "results/figures/densenet121_learning_rate.png"
    ...
    plt.title("DENSENET121 Training Time per Epoch")
    plt.grid(True, alpha=0.3)

    plt.tight_layout()

    time_path = "results/figures/densenet121_epoch_time.png"
...
def main():
    ...
    print(
        "GENERATING DENSENET121 FIGURES"
    )
