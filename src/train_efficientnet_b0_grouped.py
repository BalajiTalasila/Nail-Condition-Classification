...
# IMPORTANT:
# This is the new leakage-safe grouped dataset split.
DATA_DIR = (
    PROJECT_DIR
    / "data"
    / "grouped_split"
...
def main():
    ...
    print(
        "\nStarting leakage-safe training...\n"
    )
    ...
    for epoch in range(
        ...
        if validation_loss < best_validation_loss:
            ...
            print(
                "\nNew best model saved successfully!"
            )
    ...
    history_path = (
        ...
        / "efficientnet_b0_grouped_training_history.csv"
    )
    ...
    summary_path = (
        ...
        / "efficientnet_b0_grouped_training_summary.csv"
    )
